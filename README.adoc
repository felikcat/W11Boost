...
== Notice
* W11Boost exceeds DoNotSpy11, W10Privacy, and O&O ShutUp 10 combined as of 24 Jan 2023 in extensiveness, and the quality of its tweaks.
* W11Boost's issues:
** Lack of configuration.
** Partial support for Windows 10 LTSC 2022.
** No GUI.
** Minimal effort put in by the original author at this point in time.
*** It's unlikely these would be solved; went the trade school route instead of mentally and physically rotting at a computer desk.
