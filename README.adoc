...
- Keep in mind that "Reduce local data collection" and "Reduce online data collection" are very aggressive and will change how you use Windows; they do not affect the security of Windows.
