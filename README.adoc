...
- "Reduce local data collection" is very aggressive, it compromises security for ultimate local privacy. It will make forensics on your computer difficult.
- "Reduce online data collection" is also very aggressive and will change how you use Windows; they do not affect the security of Windows.
