...
== Before continuing
. Use alongside my link:https://github.com/nermur/DuxOS[DuxOS] if you don't mind reinstalling Windows; it's comprehensive on removing features that have minimal/no use which impact performance noticeably.
...
== Requirements
. Windows has to be activated for some changes, use a license key, or run either link:https://github.com/abbodi1406/KMS_VL_ALL_AIO[abbodi1406's KMS_VL_ALL_AIO] or massgravel's link:https://github.com/massgravel/Microsoft-Activation-Scripts[Microsoft Activation Scripts].
...
** Installs only what's required to use Xbox Controllers (interface not included, get it link:ms-windows-store://pdp/?PFN=Microsoft.XboxDevices_8wekyb3d8bbwe[here]), Game Pass, and specific games like Forza Horizon 4 & 5.
*** To also get Game Bar, install the following link:ms-windows-store://pdp/?PFN=Microsoft.XboxGameOverlay_8wekyb3d8bbwe[here] and link:ms-windows-store://pdp/?PFN=Microsoft.XboxGamingOverlay_8wekyb3d8bbwe[here].
