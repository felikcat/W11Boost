...
== Before continuing
. It's preferred to use DuxOS (WIP, not yet released) if you don't mind reinstalling Windows, as it can be comprehensive about removing features that have minimal/no use which impact performance noticeably.
** Disabling some features are ignored on Windows versions that aren't Enterprise/Education/Server editions, especially about telemetry. Which is what DuxOS solves.
