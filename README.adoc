...
. //archive.org/details/windows-internals-part1-7th/mode/2up
** //github.com/zodiacon/WindowsInternals
. //www.microsoftpressstore.com/store/windows-internals-part-2-9780135462409
** This can be viewed for free from link://en.wikipedia.org/wiki/Z-Library[Z-Library].

. //github.com/MicrosoftDocs/windows-driver-docs/tree/staging/windows-driver-docs-pr
====
