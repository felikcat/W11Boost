...
- To further this goal, there is a C++ rewrite that has a graphical interface, but this will take me a long time to complete for a first release; not public and not ready.
