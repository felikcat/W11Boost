...
W11Boost does automatically make a system restore point if for any reason it's unsatisfactory; this works even if system restore points are disabled.

image:https://sonarcloud.io/images/project_badges/sonarcloud-highlight.svg[link=https://sonarcloud.io/summary/new_code?id=felikcat_W11Boost]

== How to use
. Go to the https://github.com/felikcat/W11Boost/releases[latest releases] to download W11Boost.

. Run W11Boost in a virtual machine first to verify functionality, and get a feel for what changes you want to make.
...
- https://github.com/SimonvBez/CPUSetSetter[CPU Set Setter]. For a Ryzen 7 9800X3D, I disable core 0 to improve the FPS and stability of games: +
image:CPUSetSetter.png[]
