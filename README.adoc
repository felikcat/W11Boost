...
. After prompted to reboot, run 'Icaros'; located at: `"C:\Program Files\Icaros\IcarosConfig.exe"`
. Use the following settings:
image:IcarosConfig.png[]
...
. link:https://github.com/henrypp/simplewall/releases[Simplewall]
* An interactive firewall to block Windows telemetry and auto-updates even further.
