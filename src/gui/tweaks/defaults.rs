...
pub const RECOMMENDED_TWEAKS: &[&str] = &[
        ...
        "disable_copilot",
        "disable_paint_cocreator",
        "disable_paint_generative_fill",
        "disable_paint_image_creator",
        "disable_web_search",
        ...
        "install_7zip",
        "repair_svc_split_threshold",
        "repair_cleanup_timer_resolution",
        "repair_win32_priority_separation",
        "repair_tcp_autotuning",
        "repair_sysmain",
        "repair_ordinary_dpcs",
        "repair_spectre_meltdown",
        "repair_hpet",
        "repair_queue_sizes",
        "repair_csrss_priority",
        "repair_mpo",
        "repair_memory_management",
        "repair_raw_mouse_throttle",
        "repair_prefetch",
        "repair_nvme_driver_hacks",
        "repair_appx_service",
        "repair_uac",
        "repair_background_apps_global",
        "repair_tablet_input_service",
        "repair_ci_env_var",
        "repair_error_reporting",
        "disable_speech_updates",
        "disable_content_delivery_manager",
