...
pub static FORENSICS_TWEAKS: &[Tweak] = &[
        ...
        crate::tweak! {
                ...
                enabled_ops: &[
                        ...
                        crate::reg_dword!("HKLM", r"SYSTEM\CurrentControlSet\Services\PcaSvc", "Start", 4),
                        crate::reg_dword!("HKLM", r"SYSTEM\CurrentControlSet\Services\AeLookupSvc", "Start", 4),
                ],
        },
        crate::tweak! {
                id: "disable_bam_dam",
                ...
                enabled_ops: &[
                        crate::reg_dword!("HKLM", r"SYSTEM\CurrentControlSet\Services\bam", "Start", 4),
                        crate::reg_dword!("HKLM", r"SYSTEM\CurrentControlSet\Services\dam", "Start", 4),
                ],
        },
        crate::tweak! {
